...
```json
{
  ...
  "problem_contract": {
    ...
    "aliases": [
      "wikipedia:wikipedia-e66a0651e91c5c1d"
    ],
    "allowed_axioms": [
    ...
    "domain": {
      "description": "Draft source observation in Graph theory, Games on graphs; domain extraction is unresolved.",
      "objects": [
    ...
    "problem_id": "problem:wikipedia-e66a0651e91c5c1d",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "wikipedia-e66a0651e91c5c1d",
        "url": "https://en.wikipedia.org/wiki/Graph_coloring_game"
      }
    ],
    "statement": {
      "language": "en",
      "text": "Suppose Alice has a winning strategy for the vertex coloring game on a graph $G$ with $k$ colors. Does she have one for $k+1$ colors?",
      "version": 1
    },
    "title": "Suppose Alice has a winning strategy for the vertex coloring game on a graph $G$ with $k$ colors.",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "f6174320beb377f831a981e53a899e84b67bf12a73df980eac50454bdf135444"
}
```
